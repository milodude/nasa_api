...
// in nasa_api/test/features/last_week_pictures/data/data_source/apod_data_source_test.dart.
...
import 'package:nasa_api/core/providers/url_provider.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUrlProvider extends _i1.Mock implements _i7.UrlProvider {
  MockUrlProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i3.Future<Map<String, String>> getHeaders() => (super.noSuchMethod(
        Invocation.method(
          #getHeaders,
          [],
        ),
